...
import static cl.prueba.tecnica.seguridad.Constants.ISSUER_INFO;
...
import static cl.prueba.tecnica.seguridad.Constants.TOKEN_EXPIRATION_TIME;
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			return authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(
					credenciales.getNameUsuario(), credenciales.getPwsUsuario(), new ArrayList<>()));
		} catch (IOException e) {
